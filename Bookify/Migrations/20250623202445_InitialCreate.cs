        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentReadingStreak = table.Column<int>(type: "int", nullable: false),
                    LongestReadingStreak = table.Column<int>(type: "int", nullable: false),
                    LastStreakActivityDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDailyActivityLogs", x => x.ActivityLogID);
                    table.ForeignKey(
                        name: "FK_UserDailyActivityLogs_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBookRatings", x => x.RatingID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Participants", x => new { x.UserId, x.SpaceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Summaries_Chapters_ChapterID",
                        column: x => x.ChapterID,
                        principalTable: "Chapters",
                        principalColumn: "ChapterID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserQuizResults", x => x.ResultID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBookRatings_UserID_BookID",
                table: "UserBookRatings",
                columns: new[] { "UserID", "BookID" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserDailyActivityLogs_UserID_ActivityDate",
                table: "UserDailyActivityLogs",
